function AnswerTwo
% This is question 2 main program
A = [3 -1 0 0 0 1/2;-1 3 -1 0 1/2 0;0 -1 3 -1 0 0; 0 0 -1 3 -1 0; 0 1/2 0 -1 3 -1;1/2 0 0 0 -1 3]; %the coefficient matrix
B=[5/2;3/2;1;1;3/2;5/2];        %the constant term on the right side matrix
X0=[0;0;0;0;0;0];               %initial vector of iteration
eps = 1e-3;                     %tolerance

AnswerTwo_Function(A, B, X0, 500, 1e-3);% call answer two function
