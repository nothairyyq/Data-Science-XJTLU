...
(:Some editors use data to retrieve valua of an attribute:)
...
//Magazine[Title = //Book/Title]/Title                              
...
(:***************************************************************
   SIBLING AXIS
   All books with non-unique titles

****************************************************************:)

Bookstore/Book[Title =following-sibling::*/Title]/Title
