...
This file exercises suppose to run by opening this document directly in xml editor. 
...
<Average>
  { let $plist := /Bookstore/Book/@Price
    return avg($plist) }
</Average>
...
for $b1 in /Bookstore/Book
for $b2 in /Bookstore/Book
